  ...
  const submitItem = async (event: FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        editingId ? `/api/hospitality/${editingId}` : "/api/hospitality",
        {
      ...
      <>
        ...
        <section className="section">
          <div className="section-title">
            ...
            <p>Vui lòng đăng nhập để quản lý Hotels & Residences.</p>
          </div>
      ...
      <aside className="admin-sidebar">
        <div className="admin-sidebar-top">
          ...
          <nav className="admin-menu">
            <a href="/admin">F&B</a>
            <a className="active">Hotels & Residences</a>
          ...
          <div className="admin-modal" onClick={resetForm}>
            ...
            >
              <div className="admin-modal-header">
                <div>
                  <h2>{editingId ? "Cập nhật" : "Thêm mới"}</h2>
