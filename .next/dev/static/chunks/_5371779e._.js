...
function AdminPage() {
    ...
    const loadItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminPage.useCallback[loadItems]": async ()=>{
            setLoading(true);
            try {
    ...
    }["AdminPage.useCallback[loadItems]"], [
        page,
        limit,
        search,
        typeFilter
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminPage.useEffect": ()=>{
            ...
            }["AdminPage.useEffect.timer"], 250);
            return ({
                "AdminPage.useEffect": ()=>window.clearTimeout(timer)
            })["AdminPage.useEffect"];
        }
    }["AdminPage.useEffect"], [
        user,
...
_s(AdminPage, "qukvG+qzrisnrzcTxQkbdYc+Nkw=");
_c = AdminPage;
var _c;
