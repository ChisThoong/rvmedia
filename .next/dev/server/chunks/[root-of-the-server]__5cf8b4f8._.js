...
"[project]/app/api/landmarks/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const [items, total, types] = await Promise.all([
        db.collection("landmarks").find(query).sort({
            createdAt: -1
        }).skip((page - 1) * limit).limit(limit).toArray(),
        db.collection("landmarks").countDocuments(query),
        db.collection("landmarks").distinct("categories")
    ]);
...
async function POST(request) {
    ...
    try {
        ...
        const client = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"];
        const db = client.db(process.env.MONGODB_DB || "rvmedia");
        const result = await db.collection("landmarks").insertOne({
            embed: body.embed,
            title: body.title,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5cf8b4f8._.js.map